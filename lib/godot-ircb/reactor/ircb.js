...
// 
//
var Ircb = module.exports = function Irc(options) {
...
//
utile.inherits(Ircb, ReadWriteStream);
...
//
Ircb.prototype.write = function (data) {
...
Ircb.prototype.formatter = function (data) {
